...
jQuery( function( $ ) {
  ...
  var cart_shipping = {
    ...
    init: function( cart ) {
      ...
      $( document ).on(
        'change',
        'select.shipping_method, :input[name^=shipping_method], #pickup_date',
      ...
      $( document ).on(
        ...
        function () {
          ...
          typingTimer = setTimeout(selff.shipping_method_selected, doneTypingInterval);
        }
      );
      $( document ).on(
        'submit',
