...
>
	<div class="lastudio-kit-settings-page__avaliable-controls">
		<div class="cx-vui-title cx-vui-title--divider"><?php _e( 'Avaliable Widgets', 'lastudio-kit' ); ?></div>
		<div
	...
	<div class="lastudio-kit-settings-page__avaliable-controls">
		<div class="cx-vui-title cx-vui-title--divider"><?php _e( 'Avaliable Extensions', 'lastudio-kit' ); ?></div>
		<div
			class="lastudio-kit-settings-page__avaliable-control"
